...
/**
 * Enhanced responsive form component for AIRAVATA
          ...
          <div className="space-y-8 lg:pl-8">
            ...
            <div className="p-6 bg-gray-900/30 rounded-lg backdrop-blur-sm border border-gray-700">
              <ResponsiveText
                ...
                className="text-gray-300"
              >
                Ready to revolutionize your travel experience? Contact AIRAVATA today to learn more about our cutting-edge air taxi services and be part of the future of urban mobility.
              </ResponsiveText>
            </div>
          </div>
        )}
