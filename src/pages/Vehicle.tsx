        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-white/80 font-medium tracking-wide max-w-3xl mx-auto">
              Engineered for performance, designed for safety, built for the future of urban aviation.
            </p>
            <div className="w-32 h-0.5 bg-airavata-blue mx-auto mt-8"></div>
          </div>

          {/* Specifications Grid */}
          <div ref={specsContentRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {vehicleSpecs.map((spec, index) => (
              <div 
                key={index}
                className="spec-card group bg-airavata-gray/20 backdrop-blur-sm border border-airavata-gray rounded-lg p-6 hover:border-white/50 hover:bg-white/10 hover:shadow-2xl hover:shadow-white/20 transition-all duration-500 hover:scale-105 cursor-pointer"
              >
                {/* Icon */}
                <div className="w-16 h-16 bg-gradient-to-br from-airavata-blue/20 to-airavata-blue/10 rounded-lg flex items-center justify-center mb-6 group-hover:from-airavata-blue/30 group-hover:to-airavata-blue/20 transition-all duration-300">
                  <div className="text-airavata-blue">
                    {spec.icon}
                  </div>
                </div>
                
                {/* Content */}
                <h3 className="text-white font-bold text-lg mb-3 tracking-wide group-hover:text-white group-hover:scale-105 transition-all duration-300 uppercase">
                  {spec.title}
                </h3>
                <div className="text-airavata-blue text-2xl font-bold mb-4">
                  {spec.value}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
            ...
            <div className="relative rounded-xl overflow-hidden border-2 border-white/20 group">
              <img 
                ...
                alt="Airavath eVTOL Aircraft"
                className="w-full h-96 object-contain bg-gradient-to-br from-airavata-gray/20 to-black p-8 group-hover:scale-105 transition-transform duration-500"
              />
            ...
            <div className="relative rounded-xl overflow-hidden border-2 border-white/20 group">
              <img 
                src="./videos/cityairbusnextgen-04-airbushelicopters-1024x437.jpeg"
                alt="eVTOL Technical Diagram"
                className="w-full h-96 object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
              <div className="absolute bottom-6 left-6 text-white">
                <h3 className="text-lg font-bold mb-2">Advanced Engineering</h3>
                <p className="text-sm text-white/80">Cutting-edge eVTOL design and architecture</p>
              </div>
            </div>
          </div>
        </div>
